...
public class ExcelImportUtil {
    ...
    /**
     * @description: 重载excel数据导入方法
     * @author: 上青天
     * @date: 2024/1/28 16:52
     * @param: [workbook, pojoClass, params]
     * @return: java.util.List<T>
     **/
    public static <T> List<T> importExcel(Workbook workbook, Class<?> pojoClass,
                                          ImportParams params) throws Exception {
        return new ExcelImportServer().importExcelByIs(workbook, pojoClass, params).getList();
    }
