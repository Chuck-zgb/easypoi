...
public class CellValueServer {
    ...
    private Object getCellValue(String xclass, Cell cell, ExcelImportEntity entity) {
        ...
        if ("class java.util.Date".equals(xclass) || "class java.sql.Date".equals(xclass)
            ...
            if (Cell.CELL_TYPE_NUMERIC == cell.getCellType() && cn.afterturn.easypoi.util.DateUtil.isCellDateFormatted(cell)) {
        ...
        } else if (Cell.CELL_TYPE_NUMERIC == cell.getCellType() && cn.afterturn.easypoi.util.DateUtil.isCellDateFormatted(cell)) {
            result = DateUtil.getJavaDate(cell.getNumericCellValue());
        } else {
            switch (cell.getCellType()) {
                ...
                case Cell.CELL_TYPE_NUMERIC:
                    if (cn.afterturn.easypoi.util.DateUtil.isCellDateFormatted(cell)) {
